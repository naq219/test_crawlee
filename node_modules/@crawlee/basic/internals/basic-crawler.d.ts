...
import type { AddRequestsBatchedOptions, AddRequestsBatchedResult, AutoscaledPoolOptions, CrawlingContext, EnqueueLinksOptions, EventManager, FinalStatistics, GetUserDataFromRequest, ProxyInfo, Request, RequestList, RequestOptions, RouterHandler, RouterRoutes, Session, SessionPoolOptions, Source, StatisticState } from '@crawlee/core';
...
export declare class BasicCrawler<Context extends CrawlingContext = BasicCrawlingContext> {
     ...
     */
    protected delayRequest(request: Request, source: RequestQueue | RequestList): boolean;
    /**
